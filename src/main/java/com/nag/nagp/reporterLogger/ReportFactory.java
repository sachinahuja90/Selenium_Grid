package com.nag.nagp.reporterLogger;
...
public class ReportFactory {
	...
	public final void fail(ITestResult result) {
		...
		sw = null;
		try {
			String path = new SeleniumKeywords().getScreenshot(result.getName() + "_FailedScreenShot");
	 ...
	 * Sachin Ahuja Created on - 13th April Modified by Modified on
	 */
